...
public class GameService {
    ...
    public GameModel getGameById(Integer gameId) {
        String apiUrl = "https://api.rawg.io/api/games/"  + gameId + "?key=dd7d3386ac704b4e842e48f7bed3ddec" ;
        ...
        //Extracts the Game id, slug,name,backgorund,rating
                    GameModel game = new GameModel();
                    game.setId((Integer) result.get("id"));
                    game.setSlug((String) result.get("slug"));
                    game.setName((String) result.get("name"));
